...
class TradingConfig:
    ...
    FLIP_THRESHOLD_PARAMS = {
        'ranges': [
            ...
            {'range': [0.80, 1.00], 'buy_ratio': 2.5, 'sell_ratio': 3.0},  # 波动率 80-100%，买入阈值比例2.5，卖出阈值比例3.0
            {'range': [1.00, 1.20], 'buy_ratio': 2.0, 'sell_ratio': 2.5},  # 波动率 100-120%，买入阈值比例2.0，卖出阈值比例2.5
            {'range': [1.20, 999], 'buy_ratio': 1.5, 'sell_ratio': 2.0}    # 波动率 >120%，买入阈值比例1.5，卖出阈值比例2.0
        ],
        'default_buy_ratio': 5.0,  # 默认买入阈值比例
        'default_sell_ratio': 5.0  # 默认卖出阈值比例
    }
    ...
    GRID_PARAMS = {
        ...
        'volatility_threshold': {
            'ranges': [
                {'range': [0, 0.20], 'grid': 1.2},     # 波动率 0-20%，网格1.2%
